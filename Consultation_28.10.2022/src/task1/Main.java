...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try (DataOutputStream dos = new DataOutputStream(new FileOutputStream("D:/IT/john.txt"))) {
        ...
        try (DataInputStream dis = new DataInputStream(new FileInputStream("D:/IT/john.txt"))) {
